...
#### This program requires .Net version 8 or later.
...
## Class Overviews
* CodeReader - Reads in the code and handles potential fileread errors
...
* LanguageManager - Class that houses the menu system to change/add/remove languages
    * Child Class of Settings manager, because it is a topic-specific submenu that changes language settings
...
* SettingsManager - Menu system for settings
